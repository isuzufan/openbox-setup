...
### 
### SUMMARY: This script installs software for the UI, networking, and other activities. Only run this script if you have already installed Debian — without a desktop environment — using the netinstall .iso found at https://www.debian.org/distrib/netinst. ###
###
