...
#Use Scrot to take a screen capture of the entire screen, save the image to a file, 
#and then use pngquant to optimize and overwrite that file.
#
#This script is bound to the Alt+Shift+s key combo in ~/.config/openbox/rc.xml .
#
#Scrot options are:
# -a specifies the 0,0 start point of the screen capture and then the 1920 width and 1080 height
...
scrot -a 0,0,1920,1080 -p -q 99 -F $HOME/.tmp/tmp-scrot-output.png -e 'pngquant $f -s 10 -o $HOME/.tmp/tmp-scrot-output.png -f --strip'
